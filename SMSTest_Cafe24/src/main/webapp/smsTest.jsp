...
<!DOCTYPE html>
    ...
    <form method="post" name="smsForm" action="/SMSTest_Cafe24/smssend.jsp">
        ...
        <br />받는 번호
        <input type="text" name="rphone" value="010-4301-7553"> 예) 011-011-111 , '-' 포함해서 입력.
        <br />이름삽입번호
        <input type="text" name="destination" value="" size=80> 예) 010-000-0000|홍길동
        <br /> 보내는 번호
        <input type="hidden" name="sphone1" value="010">
        <input type="hidden" name="sphone2" value="4301">
        <input type="hidden" name="sphone3" value="7553">
