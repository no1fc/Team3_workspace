CREATE TABLE MEMBER(
   ...
   MEMBER_PROFILE VARCHAR(2048) DEFAULT NULL,
...
SELECT MEMBER_ID,MEMBER_NAME,MEMBER_PHONE,MEMBER_PROFILE,MEMBER_REGISTRATION_DATE,MEMBER_CURRENT_POINT,MEMBER_TOTAL_POINT,MEMBER_CREW_NUM,MEMBER_CREW_JOIN_DATE,MEMBER_LOCATION,MEMBER_ROLE
			FROM MEMBER
			WHERE MEMBER_ID = '샘플유저3@naver.com';
...
INSERT INTO MEMBER(MEMBER_ID,MEMBER_NAME,MEMBER_PASSWORD,MEMBER_PHONE,MEMBER_LOCATION) 
VALUES('샘플유저3@naver.com','샘플이름3','1234','샘플번호3','샘플지역3');
DELETE FROM MEMBER WHERE MEMBER_ID = '샘플유저3@naver.com';
DELETE FROM MEMBER WHERE MEMBER_ID = 'no1fc1@naver.com';
select * from MEMBER;
INSERT INTO MEMBER(MEMBER_ID,MEMBER_NAME,MEMBER_PASSWORD,MEMBER_PHONE,MEMBER_LOCATION,MEMBER_ROLE) 
VALUES('no1fc@naver.com','샘플이름3333','1234','샘플번호33','샘플지역3','T');
