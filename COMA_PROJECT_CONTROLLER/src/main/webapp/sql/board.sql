...
UPDATE BOARD SET BOARD_CONTENT = '테스트 글 입니다.', BOARD_TITLE = '테스트용' WHERE BOARD_TITLE = '개쩔지?'

select * from BOARD;

SELECT COUNT(*) AS BOARD_TOTAL FROM BOARD
SELECT COUNT(*) AS BOARD_TOTAL FROM BOARD WHERE BOARD_TITLE LIKE '%'||'board'||'%'
-- 샘플 데이터 삽입
INSERT INTO BOARD (BOARD_NUM,BOARD_TITLE,BOARD_CONTENT,BOARD_LOCATION,BOARD_WRITER_ID) 
	VALUES ((SELECT NVL(MAX(BOARD_NUM),0)+1 FROM BOARD),'123421341ㄷㄹㅈㄷ','ㄴㅇㄻㄹ123','서울특별시','user@naver.com')
INSERT INTO BOARD (BOARD_NUM,BOARD_TITLE,BOARD_CONTENT,BOARD_LOCATION,BOARD_WRITER_ID)
VALUES ((SELECT NVL(MAX(BOARD_NUM),0)+1 FROM BOARD), 'board_title1', 'board_content1', 'board_location1', 'user2@naver.com');
INSERT INTO BOARD (BOARD_NUM,BOARD_TITLE,BOARD_CONTENT,BOARD_LOCATION,BOARD_WRITER_ID)
VALUES ((SELECT NVL(MAX(BOARD_NUM),0)+1 FROM BOARD), 'board_title2', 'board_content2', 'board_location2', 'user2@naver.com');
INSERT INTO BOARD (BOARD_NUM,BOARD_TITLE,BOARD_CONTENT,BOARD_LOCATION,BOARD_WRITER_ID)
VALUES ((SELECT NVL(MAX(BOARD_NUM),0)+1 FROM BOARD), 'board_title3', 'board_content3', 'board_location3', 'user2@naver.com');
INSERT INTO BOARD (BOARD_NUM,BOARD_TITLE,BOARD_CONTENT,BOARD_LOCATION,BOARD_WRITER_ID)
VALUES ((SELECT NVL(MAX(BOARD_NUM),0)+1 FROM BOARD), 'board_title4', 'board_content4', 'board_location4', 'user2@naver.com');
INSERT INTO BOARD (BOARD_NUM,BOARD_TITLE,BOARD_CONTENT,BOARD_LOCATION,BOARD_WRITER_ID)
...
SELECT COUNT(*) AS BOARD_TOTAL FROM BOARD;
--ID로 검색한 글 개수 SelectOne(ONE_SEARCH_ID_COUNT)
SELECT COUNT(*) AS BOARD_TOTAL FROM BOARD WHERE BOARD_WRITER_ID = '샘플유저1';
--제목으로 검색한 글 개수 SelectOne(ONE_SEARCH_TITLE_COUNT)
SELECT COUNT(*) AS BOARD_TOTAL FROM BOARD WHERE BOARD_TITLE LIKE '%플%';
--이름으로 검색한 글 개수 SelectOne(ONE_SEARCH_NAME_COUNT)
