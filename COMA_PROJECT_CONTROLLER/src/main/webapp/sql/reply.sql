...
VALUES ((SELECT NVL(MAX(REPLY_NUM),0)+1 FROM REPLY), 'reply_content1', 1 ,'user2@naver.com');
INSERT INTO REPLY (REPLY_NUM, REPLY_CONTENT, REPLY_BOARD_NUM, REPLY_WRITER_ID)
VALUES ((SELECT NVL(MAX(REPLY_NUM),0)+1 FROM REPLY), 'reply_content2', 2 ,'user2@naver.com');
INSERT INTO REPLY (REPLY_NUM, REPLY_CONTENT, REPLY_BOARD_NUM, REPLY_WRITER_ID)
