CREATE TABLE CREW(
	...
	CREW_BATTLE_STATUS CHAR(1) DEFAULT 'N' CHECK (CREW_MATCH_STATUS IN ('T', 'F')),		--크루 매치 참여 상태여부
	CREW_PROFILE VARCHAR(2048) DEFAULT NULL	--크루 이미지 URL
);
--크루 PK로 크루 검색 CREW_NUM
SELECT CREW_NUM,CREW_NAME,CREW_DESCRIPTION,CREW_MAX_MEMBER_SIZE,CREW_LEADER,CREW_BATTLE_STATUS,CREW_PROFILE FROM CREW WHERE CREW_NUM = ?
