...
<body>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
    								...
    								<input type="hidden" id="gym_location_input" name="gym_location">
    								<input type="hidden" name="VIEW_GYM_NUM" value="${data.model_gym_num}">
	...
	<script>
			    ...
			    if (prev > 0) {
			        ...
			        preli.className = 'page-item';
					        ...
					        preli.insertAdjacentHTML("beforeend",
							           "<a id='allprev' class='page-link' href='GymMainPage.do?page="+prev+"' aria-label='Previous'>" 
			    ...
			    for (let i = first; i <= last; i++) {
			        ...
			        li.className = 'page-item';
					        ...
					        li.insertAdjacentHTML("beforeend",
						              "<a class='page-link m-2' href='GymMainPage.do?page=" + i + "' id='page-" + i + "' data-num='" + i + "'>" +
						                i +
						            "</a>");
			    ...
			    if (last < totalPage) {
			        ...
			        endli.className = 'page-item';
					        ...
					        endli.insertAdjacentHTML("beforeend",
							     "<a class='page-link' href='GymMainPage.do?page=" + next +"' id='allnext' aria-label='Next'><span aria-hidden='true'>&raquo;</span></a>");
			...
			document.addEventListener("DOMContentLoaded", function() {
			    const _totalCount = ${data.model_gym_total};  // 서버에서 전달된 전체 게시물 개수
