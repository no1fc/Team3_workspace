...
public class GymDTO {
	...
	private String model_gym_reservation_cnt; // 예약 가능 개수
	private String model_gym_price;           // 이용 가격
	
	//DTO에만 존재하는 데이터
	private int model_gym_total;      		    // 전체 게시글 개수
	...
	public String getModel_gym_reservation_cnt() {
		return model_gym_reservation_cnt;
	}
	public void setModel_gym_reservation_cnt(String model_gym_reservation_cnt) {
		this.model_gym_reservation_cnt = model_gym_reservation_cnt;
	}
	public String getModel_gym_price() {
		return model_gym_price;
	}
	public void setModel_gym_price(String model_gym_price) {
	...
	public String toString() {
		return "GymDTO [model_gym_num=" + model_gym_num + ", model_gym_name=" + model_gym_name + ", model_gym_profile="
				...
				+ model_gym_price + ", model_gym_total=" + model_gym_total + ", model_gym_max_num=" + model_gym_max_num
				+ ", model_gym_min_num=" + model_gym_min_num + ", model_gym_conditon=" + model_gym_conditon + "]";
	}
